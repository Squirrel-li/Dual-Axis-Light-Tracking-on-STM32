...
extern uint16_t ChineseTable[][16];

unsigned char LCD_DrawString(unsigned char Xpos, unsigned char Ypos, uint16_t *c, unsigned char length);
void LCD_Init(void);
void STM3210E_LCD_Init(void);
void Converse_Logo(void);
void LCD_Clear(void);

void LCD_DrawChar(unsigned char Xpos, unsigned char Ypos, uint16_t offset);
